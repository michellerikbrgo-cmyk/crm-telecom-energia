...
**Cópia servida no browser (após `npm run build`):** `http://<seu-ip>/RELATORIO-ESTADO-CRM.md` — ficheiro em `client/public/RELATORIO-ESTADO-CRM.md`.
...
*Ficheiros: `docs/RELATORIO-ESTADO-CRM.md` (repo) e `client/public/RELATORIO-ESTADO-CRM.md` (estático na raiz do site).*
